...
#pragma compile(Icon, "Gabenk\images\icons\botcoc.ico")
#pragma compile(FileDescription, Gabenk - Clash of Clans Bot)
#pragma compile(ProductName, Gabenk/LGBot - Clash of Clans Bot)
#pragma compile(ProductVersion, 8.0.0)
#pragma compile(FileVersion, 8.0.1)

#include <GUIConstants.au3>

$sBotVersion = "9.a Download now: www.gabenk-like.zz.mu"
$sBotTitle = "LGBot - v." & $sBotVersion

If FileExists (@ScriptDir & "\.developer") Then
	$sBotTitle = "Gabenk - In Development"
EndIf
...
#include "Gabenk\functions\functions.au3"
...
$ret = DllCall(@ScriptDir & "\Gabenk\BrokenBot32.dll", "str", "BrokenBotRedLineCheck", "ptr", $hHBitmap, "int", 1, "int", 1, "int", 0, "int", 0, "int", 0)
...
While 1
	...
	Switch TrayGetMsg()
		Case $tiAbout
			MsgBox(64 + $MB_APPLMODAL + $MB_TOPMOST, $sBotTitle, "Leeyonk Gabenk | LGBot" & @CRLF & @CRLF & _
