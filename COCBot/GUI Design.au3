...
; ---------------------------------------------------------------------------------------------------------------------
; Gabenk
GUISetIcon(@ScriptDir & "Gabenk\images\icons\botcoc.ico")
TraySetIcon(@ScriptDir & "Gabenk\images\icons\botcoc.ico")
$imgLogo = GUICtrlCreatePic("Gabenk\images\misc\LG_logo.jpg", 8, 405, 401, 112)
